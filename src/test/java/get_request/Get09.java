...
//Do Assertion
        Map<String,Object> actualData = response.as(HashMap.class); // json response'ı java map'e donusturduk
        ...
        assertEquals(bookingdatesMap.get("checkin"), ((Map)(actualData.get("bookingdates"))).get("checkin"));//Key-Value ikilileri String-Object
                                                                                                            // şeklinde olduğundan, Bookingdates value
                                                                                                            // kısmını casting ile Map yaptık.
